...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ auth()->user()->company->title }}</h1>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                        {{ auth()->user()->company->staff_counter }}
                                    </div>
                                </div>
                                {{--                                <div class="col">--}}
        ...
        <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ __('company.statistics.about car') }}</h6>
                </div>
                <div class="card-body">
                    <h4 class="small font-weight-bold">{{ __('company.statistics.next service') }}
                    ...
                    <h4 class="small font-weight-bold">{{ __('company.statistics.car income') }} <span
